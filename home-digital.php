...
<!-- Mirrored from www.incognitothemes.com/anno/home-digital.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2021 13:23:17 GMT -->
<head>
<meta charset="utf-8">
...
<ul>	<!-- SLIDE  -->
    ...
    <!-- LAYER NR. 1 -->
        ...
        data-fontsize="['86','56','56','30']"
  			...
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:700;">Anno is Graphic <br> Design <span class="text-bottom-line">Studio</span></div>
      ...
      <!-- LAYER NR. 2 -->
        ...
        data-fontsize="['22','22','22','12']"
  			...
  			data-paddingright="[0,0,0,0]"
  			data-paddingbottom="[10,10,10,10]"
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:400;">Graphic design is the process of visual communication<br> and problem-solving through the useof typography,<br>  photography, and illustration</div>
  		...
  		<div class="tp-caption NotGeneric-SubTitle tp-resizeme" id="slide-3045-layer-4"
  			...
  			data-paddingleft="[0,0,0,0]"><a class="btn btn-lg btn-light btn-circle" style="padding: 20px 38px;">Explore More</a></div>
        ...
        <!-- LAYER NR. 5 -->
          ...
          data-frames='[{"delay":0,"speed":3000,"frame":"0","from":"x:50px;opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":3000,"frame":"999","to":"x:50px;opacity:0;","ease":"Power3.easeInOut"}]'
    			...
    			data-paddingright="[0,0,0,0]"
    			data-paddingbottom="[0,0,0,0]"
    			data-paddingleft="[0,0,0,0]"><a class="btn btn-lg btn-light-outline btn-circle" style="padding: 20px 38px;">Buy Now</a></div>
    ...
    <!-- MAIN IMAGE -->
		<img src="assets/images/slides/home-bg-10.jpg"  alt="" class="rev-slidebg" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-kenburns="off" data-duration="20000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="200" data-offsetstart="0 0" data-offsetend="0 0" data-rotatestart="0" data-rotateend="0">
    ...
    <div class="hero-text-wrap">
        ...
        data-fontsize="['86','56','56','30']"
  			...
  			data-paddingright="[0,0,0,0]"
  			data-paddingbottom="[10,10,10,10]"
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:700;">We Design & Build<br> Digital <span class="text-bottom-line">Products</span></div>
      ...
      <!-- LAYER NR. 2 -->
        ...
        data-fontsize="['22','22','22','12']"
  			...
  			data-paddingright="[0,0,0,0]"
  			data-paddingbottom="[10,10,10,10]"
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:400;">Digital Product Definition A Single Source of Truth A Digital<br> Product Definition is an integrated system of record<br> with the most relevant</div>
    ...
    <div class="hero-text-wrap">
        ...
        data-fontsize="['86','56','56','30']"
  			...
  			data-paddingright="[0,0,0,0]"
  			data-paddingbottom="[10,10,10,10]"
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:700;">Superb Template for <br>Startups <span class="text-bottom-line">Business</span></div>
      ...
      <!-- LAYER NR. 2 -->
        ...
        data-fontsize="['22','22','22','12']"
  			...
  			data-paddingright="[0,0,0,0]"
  			data-paddingbottom="[10,10,10,10]"
  			data-paddingleft="[0,0,0,0]" style="font-family: 'Montserrat', sans-serif;font-weight:400;">A startup company, or simply a startup, is an entrepreneurial venture<br> in its early stages of operations typically aimed at resolving<br> a real life issue with an innovative product or service.</div>
...
<div class="tp-bannertimer" style="height: 3px; background-color: rgba(255, 255, 255, 0.25);"></div>	</div>
  ...
  <!--== What We Offer Start ==-->
  <section id="service" class="pt-80 pb-80 white-bg">
    <div class="container">
      <div class="row">
        <div class="col-md-4 feature-box text-left xs-mb-50 col-sm-6">
          <div class="pull-left"><i class="icon-pencil font-40px default-color"></i></div>
          <div class="pull-right">
            <h4 class="mt-0 font-700 mb-20">User Experience</h4>
            <p class="font-400 mb-0">User experience design is the process of enhancing user satisfaction</p>
          </div>
        </div>
        <div class="col-md-4 feature-box text-left xs-mb-50 col-sm-6">
          <div class="pull-left"><i class="icon-tablet font-40px default-color"></i></div>
          <div class="pull-right">
            <h4 class="mt-0 font-700 mb-20">Responsive Layout</h4>
            <p class="font-400 mb-0">Responsive design is an approach to web page creation that makes use of flexible layouts</p>
          </div>
        </div>
        <div class="col-md-4 feature-box text-left col-sm-6">
          <div class="pull-left"><i class="icon-pictures font-40px default-color"></i></div>
          <div class="pull-right">
            <h4 class="mt-0 font-700 mb-20">Digital Solutions</h4>
            <p class="font-400 mb-0">Digital Solution is a series of a solution provided by a digital marketing agency or consultant</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <!--=== Presentation Start ======-->
  <section style="background:url(assets/images/background/parallax-bg.png) center center no-repeat #e6f8f9;" class="height-600px">
  	<div class="container">
  		<div class="row">
  			<div class="col-md-8 text-left">
  				<h1 class="font-700 xs-font-20px font-40px">Superb Website Template<br> for Startups & Small Businesses.</h1>
          <p class="mt-30">
          ...
          <p class="mt-30"><a class="btn btn-lg btn-color btn-circle">Read more</a></p>
  			</div>
  		</div>
  	</div>
  </section>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 xs-mb-50">
          <h2 class="mt-0 font-700">Agency Overview</h2>
          <p class="mt-30">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 text-center">
          <h2 class="mt-0 font-700">Our Latest Works</h2>
        </div>
      </div>

      <div class="row mt-50 xs-mt-0">
        <div class="col-md-12">
            <div id="portfolio-gallery-filter" class="cbp-l-filters-alignCenter text-sm-center mb-50 xs-mb-0 transparent-bg">
      ...
      <div class="row">
        <div class="col-md-12">
          <div id="portfolio-gallery" class="cbp">
            ...
            <div class="cbp-item creative col-md-4 col-sm-6 with-spacing">
              <div class="portfolio-item">
                <a href="#">
            ...
            <div class="cbp-item creative branding col-md-4 col-sm-6 with-spacing">
              <div class="portfolio-item">
                <a href="#">
            ...
            <div class="cbp-item web-design col-md-4 col-sm-6 with-spacing">
              <div class="portfolio-item">
                <a href="#">
            ...
            <div class="cbp-item stationery photography col-md-4 col-sm-6 with-spacing">
              <div class="portfolio-item">
                <a href="#">
            ...
            <div class="cbp-item stationery col-md-4 col-sm-6 with-spacing">
              <div class="portfolio-item">
                <a href="#">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-sm-6 col-xs-12 xs-mb-30">
          ...
          <p class="mt-30">Anno template provides fully flexible templates, allowing to customize every page and section down to the tiniest detail in a few clicks!</p>
            <form name="contact-form" id="contact-form-03" action="http://www.incognitothemes.com/anno/php/contact.php" method="POST" class="contact-form-style-01 mt-50">
        ...
        <div class="col-md-5 col-sm-5 col-xs-12 xs-mb-30 mt-40 col-md-offset-1 col-sm-offset-1">
          <div id="map-style-3" class="min-height-300px relative"></div>
          <h4 class="font-700 mt-30">Contact Info</h4>
          <p class="mt-20 font-16px font-500">Patton Street Caulfield East VIC 3145</p>
          <p class="font-16px font-500">Email Us: sayhi@yoursite.com</p>
          <p class="font-16px font-500">Call Us: +61 (03) 9414 7288</p>
        </div>
      </div>
    </div>
  </section>
...
<!-- Mirrored from www.incognitothemes.com/anno/home-digital.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 27 Jan 2021 13:25:13 GMT -->
</html>
